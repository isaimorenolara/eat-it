...
class CreaPerfilWidget extends StatefulWidget {
  const CreaPerfilWidget({Key? key}) : super(key: key);

  @override
  _CreaPerfilWidgetState createState() => _CreaPerfilWidgetState();
}
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Align(
                                    alignment: AlignmentDirectional(-1.0, 0.0),
                                    child: Text(
                                      'Escoge el tipo de usuario con el que interacturás con la aplicación.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                    ),
                                  ),
                                        ...
                                        onPressed: () async {
                                          setState(() =>
                                              FFAppState().isNutriologo =
                                                  !FFAppState().isNutriologo);
                                          setState(() {
                                            FFAppState().PacienteUsuario = true;
                                          });
                                        },
                                        value: !FFAppState().isNutriologo,
                                        onIcon: Icon(
