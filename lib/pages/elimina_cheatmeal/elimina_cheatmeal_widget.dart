...
import 'elimina_cheatmeal_model.dart';
export 'elimina_cheatmeal_model.dart';

class EliminaCheatmealWidget extends StatefulWidget {
  const EliminaCheatmealWidget({Key? key}) : super(key: key);

  @override
  _EliminaCheatmealWidgetState createState() => _EliminaCheatmealWidgetState();
}

class _EliminaCheatmealWidgetState extends State<EliminaCheatmealWidget> {
  late EliminaCheatmealModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminaCheatmealModel());
