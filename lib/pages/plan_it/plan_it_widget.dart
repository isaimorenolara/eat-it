...
import 'plan_it_model.dart';
export 'plan_it_model.dart';

class PlanItWidget extends StatefulWidget {
  const PlanItWidget({
    Key? key,
    this.userreference,
  }) : super(key: key);
  ...
  @override
  _PlanItWidgetState createState() => _PlanItWidgetState();
}

class _PlanItWidgetState extends State<PlanItWidget> {
  late PlanItModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanItModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        FFAppState().Genero = valueOrDefault(currentUserDocument?.planes, '');
      });
    });
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 0.0),
                          child: Text(
                            'Descubre planes alimenticios y elige el que mas te guste',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Poppins',
                                ...
                                child:
                                  ...
                                  stream: queryPlanAlimenticioRecord(
                                    queryBuilder: (planAlimenticioRecord) =>
                                        planAlimenticioRecord.where('nombre',
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      2.0, 0.0, 0.0, 15.0),
                                  child: Text(
                                    'Nutriologos que te pueden ayudar',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                                      ...
                                                      await Navigator.push(
                                                        ...
                                                        PageTransition(
                                                          ...
                                                          child:
                                                            ...
                                                            image: Image.asset(
                                                              'assets/images/nutriologoItem.png',
                                                              fit: BoxFit
                                                                  .contain,
                                                            ),
                                                            allowRotation:
