...
import 'ine_pagina_model.dart';
export 'ine_pagina_model.dart';

class InePaginaWidget extends StatefulWidget {
  const InePaginaWidget({Key? key}) : super(key: key);

  @override
  _InePaginaWidgetState createState() => _InePaginaWidgetState();
}

class _InePaginaWidgetState extends State<InePaginaWidget> {
  late InePaginaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InePaginaModel());
  }
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamedAuth(
                                          'ValidandoPerfil', mounted);

                                      final ineCreateData1 =
                                          createIneRecordData(
                                        imagenF: FFAppState().ImagenF,
                                        imagenT: FFAppState().ImagenT,
                                      );
                                      await IneRecord.collection
                                          .doc()
                                          .set(ineCreateData1);
