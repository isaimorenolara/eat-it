...
import 'agrega_cheatmeal_model.dart';
export 'agrega_cheatmeal_model.dart';

class AgregaCheatmealWidget extends StatefulWidget {
  const AgregaCheatmealWidget({Key? key}) : super(key: key);

  @override
  _AgregaCheatmealWidgetState createState() => _AgregaCheatmealWidgetState();
}

class _AgregaCheatmealWidgetState extends State<AgregaCheatmealWidget> {
  late AgregaCheatmealModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregaCheatmealModel());
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Cheat meal mes${FFAppState().Mes.toString()}',
