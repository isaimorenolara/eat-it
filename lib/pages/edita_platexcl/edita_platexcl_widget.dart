...
import 'edita_platexcl_model.dart';
export 'edita_platexcl_model.dart';

class EditaPlatexclWidget extends StatefulWidget {
  const EditaPlatexclWidget({Key? key}) : super(key: key);

  @override
  _EditaPlatexclWidgetState createState() => _EditaPlatexclWidgetState();
}

class _EditaPlatexclWidgetState extends State<EditaPlatexclWidget> {
  late EditaPlatexclModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaPlatexclModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('agrega_platexcl');
                          },
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 13.0, 0.0, 8.0),
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('elimina_platexcl');
                          },
