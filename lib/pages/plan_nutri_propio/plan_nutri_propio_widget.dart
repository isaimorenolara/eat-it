...
import 'plan_nutri_propio_model.dart';
export 'plan_nutri_propio_model.dart';

class PlanNutriPropioWidget extends StatefulWidget {
  const PlanNutriPropioWidget({
    Key? key,
    this.currentPlan,
  }) : super(key: key);
  ...
  @override
  _PlanNutriPropioWidgetState createState() => _PlanNutriPropioWidgetState();
}

class _PlanNutriPropioWidgetState extends State<PlanNutriPropioWidget> {
  late PlanNutriPropioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanNutriPropioModel());
  }
