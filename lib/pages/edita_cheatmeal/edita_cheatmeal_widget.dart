...
import 'edita_cheatmeal_model.dart';
export 'edita_cheatmeal_model.dart';

class EditaCheatmealWidget extends StatefulWidget {
  const EditaCheatmealWidget({Key? key}) : super(key: key);

  @override
  _EditaCheatmealWidgetState createState() => _EditaCheatmealWidgetState();
}

class _EditaCheatmealWidgetState extends State<EditaCheatmealWidget> {
  late EditaCheatmealModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaCheatmealModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('agregacheatmeal');
                          },
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('elimina_cheatmeal');
                          },
