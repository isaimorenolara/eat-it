...
import 'elimina_platexcl_model.dart';
export 'elimina_platexcl_model.dart';

class EliminaPlatexclWidget extends StatefulWidget {
  const EliminaPlatexclWidget({Key? key}) : super(key: key);

  @override
  _EliminaPlatexclWidgetState createState() => _EliminaPlatexclWidgetState();
}

class _EliminaPlatexclWidgetState extends State<EliminaPlatexclWidget> {
  late EliminaPlatexclModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EliminaPlatexclModel());
