...
import 'agrega_platexcl_model.dart';
export 'agrega_platexcl_model.dart';

class AgregaPlatexclWidget extends StatefulWidget {
  const AgregaPlatexclWidget({Key? key}) : super(key: key);

  @override
  _AgregaPlatexclWidgetState createState() => _AgregaPlatexclWidgetState();
}

class _AgregaPlatexclWidgetState extends State<AgregaPlatexclWidget> {
  late AgregaPlatexclModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregaPlatexclModel());
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Platillo exclusivo mes${FFAppState().Mes.toString()}',
